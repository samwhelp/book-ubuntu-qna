...
source_url: '/read/howto/explore/package-filelist.md'
---

## 前提

接續上一篇『[找「已安裝套件」的「檔案列表」](/book-ubuntu-qna/read/howto/explore/package-installed-filelist.html)』，以「[coreutils](http://packages.ubuntu.com/xenial/coreutils)」這個套件來當案例說明。
